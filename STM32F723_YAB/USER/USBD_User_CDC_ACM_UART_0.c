...
// UART Configuration ----------------------------------------------------------
  ...
  #define  UART_PORT              6       //STLINK-V3MINI, USART6,  PG9-Rx / PG14-Tx
#else //#if !defined (USE_STM32F723E_DISCO)
  #define  UART_PORT              2       // UART Port number, USE_STM32F723E_DISCO = USART2, PA3-Rx / PA2-Tx
#endif //#if !defined (USE_STM32F723E_DISCO)
